...
alias rkhuntupd='sudo rkhunter --update --propupd' # Update file property database of rkhunter
alias rkhuntchk='sudo rkhunter --check --skip-keypress' # Check the system for root kits using rkhunter
